...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/vendors/css/extensions/tether-theme-arrows.css">
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/vendors/css/extensions/tether.min.css">
    <!-- <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/vendors/css/extensions/shepherd-theme-default.css"> -->
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/css/pages/dashboard-analytics.css">
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/css/pages/card-analytics.css">
    <!-- <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}public/app-assets/css/plugins/tour/tour.css"> -->
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="card bg-analytics text-white">
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        <img src="{{env('APP_URL')}}public/app-assets/images/elements/decore-left.png" class="img-left" alt="
            card-img-left">
                                        <img src="{{env('APP_URL')}}public/app-assets/images/elements/decore-right.png" class="img-right" alt="
            card-img-right">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mb-2 text-white">Congratulations {{auth()->user()->first_name}},</h1>
                                            <p class="m-auto w-75">You have done <strong>57.6%</strong> more task today. Check your new task in your profile.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1 mb-25">1.6k</h2>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <p class="mb-0">Donation Received</p>
                                </div>
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <div class="row pb-50">
                                            <div class="col-lg-6 col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                                                <div>
                                                    <h2 class="text-bold-700 mb-25">20.7K</h2>
                                                    <p class="text-bold-500 mb-75">Avg Donation</p>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-2 col-12 d-flex flex-column flex-wrap text-center">
                                                <h1 class="font-large-2 text-bold-700 mt-2 mb-0">50</h1>
                                        ...
                                        <div class="chart-info d-flex justify-content-between">
                                            <div class="text-center">
                                                <p class="mb-50">New Campaign</p>
                                                <span class="font-large-1">19</span>
                                            </div>
                                            <div class="text-center">
                                                <p class="mb-50">Open Campaign</p>
                                                <span class="font-large-1">10</span>
                                            </div>
                                            <div class="text-center">
                                                <p class="mb-50">Success Campaign</p>
                                                <span class="font-large-1">21</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <td class="p-1">
                                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                            ...
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Elicia Rieske" class="avatar pull-up">
                                                                <img class="media-object rounded-circle" src="{{env('APP_URL')}}public/app-assets/images/portrait/small/avatar-s-7.png" alt="Avatar" height="30" width="30">
                                                            </li>
    ...
    <script src="{{env('APP_URL')}}public/app-assets/vendors/js/extensions/tether.min.js"></script>
    <!-- <script src="{{env('APP_URL')}}public/app-assets/vendors/js/extensions/shepherd.min.js"></script> -->
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{env('APP_URL')}}public/app-assets/js/scripts/pages/dashboard-analytics.js"></script>
    <!-- END: Page JS-->

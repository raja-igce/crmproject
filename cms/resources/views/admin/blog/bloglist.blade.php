                  ...
                  <div class="row breadcrumbs-top">
                      <div class="col-12">
                          ...
                          <div class="content-body">
                            ...
                            <button type="button" class="pull-right btn btn-primary " onclick="opensider('add')" id="opensider">
                                        ...
                                        <div class="row">
                                              <div class="col-lg-4 col-sm-6 col-xs-12">
                                                           <div class="form-group">
                                                               ...
                                                               <select data-placeholder="Select category..." class="select2 form-control" id="cause_id" name="cause_id" v-model="cause_id"  required>
                                              ...
                                              <div class="col-lg-4 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select data-placeholder="Select Organization..." class="select2 form-control" id="organization_id" name="organization_id"  v-model="organization_id" required>
                                                                        <option  value="" >All Organization</option>
                                                                        <option v-for="data in orgList"    :value="data.id"   >@{{data.first_name}} @{{data.last_name}}</option>
                                                                </select>
                                                            </div>
                                              </div>
                                              <div class="col-lg-4 col-sm-6 col-xs-12">
                                                  <div class="  collapse-header">
                                                    <div class="form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control round mt-2" id="txtsearch"  v-model="txtsearch" value="">
                                             ...
                                             <form action="#" id="frmAddData" name="frmAddData" class="steps-validation ">
                                               ...
                                               <input type="hidden" name="user_id" id="user_id" value="">
                                                      <div class="row">
                                                          <div class=" col-lg-6">
                                                              <div class="form-group">
                                                                  <label for="title">Blog post for</label>
                                                                  <select data-placeholder="Select category..." class="select2 form-control" id="org_id" name="org_id"   required>
                                                                        <option v-for="data in orgList"    :value="data.id"   >@{{data.first_name}} @{{data.last_name}}</option>
                                                                  </select>
                                                                </div>
                                                          </div>
                                                      ...
                                                      <div class="row">
                                                       <div class="col-lg-6">
                                                           <div class="form-group">
                                                               <label for="title">Blog Title*</label>
                                                                <input type="text"  data-msg="Please enter blog title"  id="title" class="form-control" required placeholder="title" name="title">
                                                           </div>
                                                       </div>
                                                       <div class="col-lg-6">
                                                           <div class="form-group">
                                                               <label for="title">Sub Title*</label>
                                                                <input type="text"  data-msg="Please enter sub title"  id="subtitle" class="form-control" required placeholder="sub title" name="subtitle">
                                                           </div>
                                                       </div>
                                                       ...
                                                       <div class=" col-lg-3 col-sm-6 col-xs-12">
                                                           <div class="form-group">
                                                               <label for="title">Cause</label>
                                                               <select data-placeholder="Select category..." class="select2 form-control" id="project_id" name="project_id"   required>
                                                                    <option v-for="data in projectList"    :value="data.id"   >@{{data.project_name}}</option>
                                                               </select>
                                                            </div>
                                                       </div>     
                                                       ...
                                                       <div class="col-lg-5">
                                                            ...
                                                            <div class="Outputshow" id="ImageGallery">
                                                              <div v-for="(data, key) in eventImages" title=""  class="profile-picImg GalleryBox" :id="'GalleryBox'+data.image">
                                                                ...
                                                                <img id="galimgDocument1556361385_85" :src="'{{BlogAbsPath}}'+data.id+'/Thumb/'+data.image" class="profile-picImg">
                                                              </div>
                                                            </div>
                                          ...
                                          <table class="table zero-configuration" id="">
                                              <thead>
                                                  <tr class="text-uppercase">
                                                      <th>id</th>
                                                      <th class="fulltblrow">Blog Title</th>
                                                      <th class="fulltblrow">Creator</th>
                                                      <th class="fulltblrow">Organization</th>
                                                      <th class="fulltblrow">Cause</th>
                                              ...
                                              <tbody >
                                                ...
                                                <tr>
                                                      ...
                                                      <td>@{{user.title}}</td>
                                                      <td class="fulltblrow">
                                                          <img class="media-object rounded-circle" :src="'{{TeamImagePath}}'+user.get_creator.id+'/Thumb/'+user.get_creator.profile_pic" onerror="this.src='{{FrontAssets}}images/defaulticon.png'"  :alt="'{{TeamImagePath}}'+user.get_creator.id+'/Thumb/'+user.get_creator.profile_pic" height="30" width="30"> @{{user.get_creator.first_name}}
                                                      </td>
                                                      <td><span v-if="user.get_organization">@{{user.get_organization.first_name}}</span></td>
                                                      <td><span v-if="user.get_project">@{{user.get_project.project_name}}</span></td>
 ...
 var vm = new Vue({
   ...
   methods:{
     ...
     getUserDetails:function(id,jsondata){
                  ...
                  $('#org_id').val([jsondata.organization_id]);
                  $('#org_id').trigger('change');
                  

                  $('#project_id').val([jsondata.project_id]);
                  ...
                  var itemItem = [];
                  $.each(JSON.parse(jsondata.tags), function (index, value){

                                                      ...
                                                      <div class="row">
                                                       ...
                                                       <div class=" col-lg-3 col-sm-6 col-xs-12">
                                                           <div class="form-group">
                                                               ...
                                                               <select data-placeholder="Select category..." class="select2 form-control" id="category_id" name="category_id"   required>
                                                                    <option v-for="data in categoryList"    :value="data.id"   >@{{data.title}}</option>
                                                               </select>
                                                            </div>
                                                       </div>     
                                          ...
                                          <table class="table zero-configuration" id="">
                                              <thead>
                                                  <tr class="text-uppercase">
                                                      ...
                                                      <th class="fulltblrow">Category</th>
                                              ...
                                              <tbody >
                                                ...
                                                <tr>
                                                      ...
                                                      <td><span v-if="user.get_blog_category">@{{user.get_blog_category.title}}</span></td>

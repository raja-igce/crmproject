            ...
            <section class="page-users-view">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <form action="" id="frmAddData2" name="frmAddData2">
                                            <div class="users-view-image text-center">
                                                    ...
                                                    <img id="image1" :src="'{{UserPath}}'+userDetail.id+'/Thumb/'+userDetail.profile_pic" onerror="this.src='{{Assets}}images/user.png'" class="users-avatar-shadow w-100 rounded mb-0 mr-1 ml-1  " style="width: 125px !important"  onclick="document.getElementById('imagefile_pro').click()" alt="avatar">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">NGO Darpan Unique ID</td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="col-md-6 col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title mb-2">Communication  Information</div>
                                </div>
                                <div class="card-body">
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">YouTube Channel</td>
                                            <td v-if="userDetail.address_line1">    </td>
                                            <td>-</td>
                                        </tr>
                                                    ...
                                                    <!-- Step 1 -->
                                                        ...
                                                        <div class="col-md-3 col-sm-5 col-xs-11">
                                                            ...
                                                            <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                <input type="text"  data-msg="Please enter first name"  id="first_name" class="form-control" required placeholder="First name" name="first_name"   >
                                                        ...
                                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                        <input type="text" id="last_name" class="form-control"  data-msg="Please enter last name" required placeholder="Last Name" name="last_name">
                                                                        <div class="form-control-position">
                                                                            <i class="feather  icon-user"></i>
                                                                        </div>
                                                                    </fieldset>
                                                        ...
                                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <fieldset class="form-group position-relative has-icon-left input-divider-left">
                                                                            <input type="text" id="phone" class="form-control" required name="phone" placeholder="Phone Number">
                                                                            <div class="form-control-position">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="pincode" maxlength="6" class="form-control" name="pincode" placeholder="Pincode">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div v-if="img_report" v-for="(data, key) in img_report" title=""   class="profile-picImg GalleryBox" style="display: table;max-width: 1px;word-wrap: anywhere;" :id="'GalleryBox'+data.file">
                                                                        <input type="hidden" :value="data.file" name="imagename[]" id="imagename">

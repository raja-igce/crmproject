<head>
    ...
    <meta name="description" content="InnerEye">
    <meta name="keywords" content="InnerEye">
    <meta name="author" content="InnerEye">
    ...
    <script src="{{env('APP_URL')}}public/assets/js/vue.js"></script>
    @yield('appcss')
    <!-- END: Custom CSS-->

...
<head>
    ...
    <meta name="description" content="iNNER-EYE (iEF)">
    <meta name="keywords" content="innereye,Compassion,Charity,Service">
    <meta name="author" content="iNNER-EYE">
    <title>iNNER-EYE (iEF): Compassion | Charity | Service</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{env('APP_URL')}}public/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        @if ($errors->has('email'))
                                                <p class="px-2 error">{{ $errors->first('email') }}</p>
                                        @endif
                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" id="email" name="email" type="email" placeholder="Email" required>
                                        ...
                                        <div class="login-footer">
                                            ...
                                            <div class="pb-3">
                                                <a href="{{route('logins')}}" class="pull-left">Login as Volunteer</a>
                                                <a href="{{route('logins')}}" class="pull-right">Login as Organization</a>
                                            </div>
